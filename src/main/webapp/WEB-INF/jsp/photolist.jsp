...
<div class="container-fluid">
	...
	<div class="row placeholders">
			...
			<tr>			
				...
				<td><img src="${pageContext.request.contextPath}/resources/carousel/${photo.image}" height="50" width="100"/> </td>
			<td><a href="${pageContext.request.contextPath}/admin/editimage/${photo.id}" class="btn btn-info" >Edit</a></td>
			<td><a href="${pageContext.request.contextPath}/admin/delimage/${photo.id}" class="btn btn-danger" >Delete</a> </td>
			</tr>
			</c:forEach>
		</table>
</div></div></div></div>		</div>
