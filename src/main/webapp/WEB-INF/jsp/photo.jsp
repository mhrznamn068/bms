...
<div class="container-fluid">
	...
	<h4>${success}</h4>
	<h4>${failure}</h4>
	<form:form action="${pageContext.request.contextPath}/admin/addimage?${_csrf.parameterName}=${_csrf.token}" method="post" commandName="photo" enctype="multipart/form-data">
