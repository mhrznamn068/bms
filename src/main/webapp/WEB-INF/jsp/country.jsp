...
<div class="container-fluid">
	...
	<form:form action="${pageContext.request.contextPath}/moderator/addcountry" method="POST" commandName="country">
		<div class="form-group">
		<form:label path="countryid"> <spring:message text="Id" /> </form:label>
		<form:input path="countryid" readonly="true" size="8" disabled="true"/> <form:hidden path="countryid" />
		</div>
		
		<div class="form-group">
		<form:label path="countryname">Name</form:label>
