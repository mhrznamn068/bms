...
<div class="container-fluid">
	...
	<div class="row placeholders">
			...
			<tr>			
				...
				<td><a href="${pageContext.request.contextPath}/admin/updatebrand/${brand.brandid}" class="btn btn-info" >Edit</a></td>
				<td><a href="${pageContext.request.contextPath}/admin/deletebrand/${brand.brandid}" class="btn btn-danger" >Delete</a> </td>
			</tr>
			</c:forEach>
		</table>
</div></div></div></div>		</div>
