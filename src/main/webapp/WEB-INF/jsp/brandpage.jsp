...
<body>
	...
	<section>
			...
			<div class="row">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									<c:url value="/category/${cat.catid}" var="url">
  										<c:param name="21bngg" value="/ckjasbckj/asf/nmvbasdawd" />
  										<c:param name="basfm" value="/zasdaaj/asdf/nmvbasdawd" />
									</c:url>
                   						<h4 class="panel-title"> <a href="${url}" class="list-group-item">${cat.catname}</a> </h4>
				...
				<div class="col-sm-9 padding-right">
					...
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Bag List</h2>
						<c:forEach items="${bagbrand}" var="bag" >
						<div class="col-sm-4">
		...
		<%-- <div class="pagination">
        	<ul>
           		<li><a href="${pageContext.request.contextPath}/brand/${brandid}/?page=0">1</a></li>
            	<li><a href="${pageContext.request.contextPath}/brand/${brandid}/?page=1">2</a></li>
            	<li><a href="${pageContext.request.contextPath}/brand/${brandid}/?page=2">3</a></li>
            	<li><a href="${pageContext.request.contextPath}/brand/${brandid}/?page=3">4</a></li>
            	<li><a href="${pageContext.request.contextPath}/brand/${brandid}/?page=4">5</a></li>
            </ul>
    	</div> --%>
    	...
    	<div class="pagination">
		    <ul>
        		...
        		<a href="<c:url value="/brand/${brandid}/" >
        		<c:param name="page" value="${p-1}"/>${p}</c:url>">${p}</a>
        		</c:forEach>
        		</li>
    		</ul>
		</div>
