...
<div class="container-fluid">
	...
	<h4>${success}</h4>
	<h4>${failure}</h4>
	<form:form action="${pageContext.request.contextPath}/admin/addbrand" method="post" commandName="brand">
		 ...
		 <c:if test="${!empty brand.brandname}">
				<div class="form-group">
					...
					<form:input path="brandid" readonly="true" size="8"
							disabled="true" /> <form:hidden path="brandid" />
				</div>
			</c:if> 
		
		
		<div class="form-group">
			<form:label path="brandname">Name</form:label>
