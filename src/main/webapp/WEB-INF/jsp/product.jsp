	...
	<section id="cart_items">
		...
		<div class="container product_details">
				...
				<div class="col-lg-4 product_img">
					<img src="${pageContext.request.contextPath}/resources/bagimages/${bag.image}">
				</div>
				
				
				<div class="col-lg-6 productdetail">
					<h5>Name:${bag.bname}</h5>
					<h5>Category:${bag.category.catname}</h5>
					<h5>Brand:${bag.brand.brandname}</h5>
					<h5>Price:${bag.bprice}</h5>
					<h5>Views:${bag.bview}</h5>
				...
				<h5 class="active">Description</h5>
				<p>${bag.bdescription}</p>
				</div>
				</div>
		</div>	
