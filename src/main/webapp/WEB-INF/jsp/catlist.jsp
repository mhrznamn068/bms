...
<div class="container-fluid">
	...
	<div class="row placeholders">
			...
			<tr>			
				<td> ${cat.catid} </td>
				<td> ${cat.catname}</td>
				<td><a href="${pageContext.request.contextPath}/admin/updatecat/${cat.catid}" class="btn btn-info" >Edit</a></td>
				<td><a href="${pageContext.request.contextPath}/admin/deletecat/${cat.catid}" class="btn btn-danger" >Delete</a> </td>
			</tr>
			</c:forEach>
		</table>
</div></div></div></div>		</div>
