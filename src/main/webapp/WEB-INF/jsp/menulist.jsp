...
<div class="container-fluid">
	...
	<table class="table">
			...
			<tr>			
				...
				<td><a href="${pageContext.request.contextPath}/admin/editmenu/${menu.mid}" class="btn btn-info" >Edit</a></td>
				<td><a href="${pageContext.request.contextPath}/admin/delmenu/${menu.mid}" class="btn btn-danger" >Delete</a> </td>			</tr>
			</c:forEach>
		</table>
		</div>
